...
def main(args):
    ...
    parser.add_argument('-s', '--search', default='sad cat image', type=str, help='search term')
    parser.add_argument('-n', '--num_images', default=10, type=int, help='num images to save')
    parser.add_argument('-d', '--directory', default='/Users/douglassmith/downloads/', type=str, help='save directory')
    ...
    for i , (img , Type) in enumerate( ActualImages[0:max_images]):
        try:
            ...
            aw_img = urllib2.urlopen(req).read()
            if len(Type)==0:
